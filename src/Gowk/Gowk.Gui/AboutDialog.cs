...
namespace Gowk.Gui
{
	public class AboutDialog : Gtk.AboutDialog
	{
		...
		{
			ProgramName = "Gowk";
			Logo = Gdk.Pixbuf.LoadFromResource("icon.png");
			Version = (new Version(Assembly.GetEntryAssembly().GetName().Version.ToString())).ToString(3);
			Comments = "A system tray indicator for the FUP Telemeter Service.";
		...
		private string GetLicenseInfo()
		{
			...
			try
			{
				...
				using (StreamReader reader = new StreamReader(assembly.GetManifestResourceStream("COPYING")))
				{
